...
import com.echo.dapc.databinding.ActivityTaskCompletedInfoBinding;
import com.echo.dapc.mvvm.model.task.TaskCompletedInfoModel;
import com.echo.dapc.mvvm.viewmodel.taskinfo.TaskCompletedInfoViewModel;

public class TaskCompletedInfoActivity extends BaseDataBindingActivity<TaskCompletedInfoViewModel, TaskCompletedInfoModel, ActivityTaskCompletedInfoBinding> {
    ...
    protected int getUILayoutId() {
        return R.layout.activity_task_completed_info;
    }
