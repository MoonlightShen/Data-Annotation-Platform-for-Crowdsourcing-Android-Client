...
import com.echo.dapc.adapter.viewholder.task.TaskAbnormalViewHolder;
import com.echo.dapc.adapter.viewholder.task.TaskAuditingViewHolder;
import com.echo.dapc.adapter.viewholder.task.TaskCompletedViewHolder;
import com.echo.dapc.adapter.viewholder.task.TaskEditingViewHolder;
import com.echo.dapc.adapter.viewholder.task.TaskPauseViewHolder;
import com.echo.dapc.adapter.viewholder.task.TaskRunningViewHolder;
...
import com.echo.dapc.mvvm.view.LoadingErrorActivity;
import com.echo.dapc.mvvm.view.task.TaskCommonInfoActivity;
import com.echo.dapc.mvvm.view.task.TaskCompletedInfoActivity;
import com.echo.dapc.mvvm.view.task.TaskDetailsActivity;
...
public final class TaskListAdapter extends BaseRecycleListAdapter<Task, TaskViewHolder> {
        ...
        setClickListener((itemview, position) -> {
            ...
            if (InfoUtil.getUserId().longValue() == task.getOwnerId()) {
                switch (task.getState()) {
                    case EDITING -> targetClass = TaskEditingInfoActivity.class;
                    case AUDITING, ABNORMAL, RUNNING, PAUSE ->
                            targetClass = TaskCommonInfoActivity.class;
                    case COMPLETED -> targetClass = TaskCompletedInfoActivity.class;
                    default -> targetClass = LoadingErrorActivity.class;
                }
            } else {
                targetClass = TaskDetailsActivity.class;
            }
