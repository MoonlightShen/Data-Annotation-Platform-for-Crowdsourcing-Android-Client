...
import com.echo.dapc.util.network.constant.UserConstant;
import com.echo.dapc.util.network.response.LoginRes;
import com.echo.dapc.util.network.response.RegisterCheckRes;
import com.echo.dapc.util.network.response.common.StatusCodeRes;
import com.echo.dapc.util.network.response.friendrequest.FriendRequestListRes;
import com.echo.dapc.util.network.response.user.FriendListRes;
import com.echo.dapc.util.network.response.user.UserInfoRes;
import com.echo.dapc.util.network.response.user.UserListRes;
