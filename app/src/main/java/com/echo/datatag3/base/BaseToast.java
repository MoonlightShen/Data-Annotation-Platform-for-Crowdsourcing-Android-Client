...
import com.echo.datatag3.util.system.BackgroundUtil;
import com.echo.datatag3.util.system.ColorUtil;
import com.echo.datatag3.util.system.DrawableUtil;
...
public final class BaseToast {
    ...
    public static Toast normal(@NonNull Context context, @StringRes int message, int duration,
        ...
        return custom(context, context.getString(message), icon, ColorUtil.getColor(context, R.color.toast_normal_tint_color),
            ColorUtil.getColor(context, R.color.toast_default_text_color), duration, withIcon, true);
    }

    @CheckResult
    public static Toast normal(@NonNull Context context, @NonNull CharSequence message, int duration,
                               Drawable icon, boolean withIcon) {
        return custom(context, message, icon, ColorUtil.getColor(context, R.color.toast_normal_tint_color),
                ColorUtil.getColor(context, R.color.toast_default_text_color), duration, withIcon, true);
    }
    ...
    public static Toast warning(@NonNull Context context, @StringRes int message, int duration, boolean withIcon) {
        return custom(context, context.getString(message), DrawableUtil.getDrawable(context, R.drawable.common_error_24dp),
                ColorUtil.getColor(context, R.color.toast_warning_color), ColorUtil.getColor(context, R.color.toast_default_text_color),
    ...
    public static Toast warning(@NonNull Context context, @NonNull CharSequence message, int duration, boolean withIcon) {
        return custom(context, message, DrawableUtil.getDrawable(context, R.drawable.common_error_24dp),
                ColorUtil.getColor(context, R.color.toast_warning_color), ColorUtil.getColor(context, R.color.toast_default_text_color),
                duration, withIcon, true);
    }
    ...
    public static Toast info(@NonNull Context context, @StringRes int message, int duration, boolean withIcon) {
        return custom(context, context.getString(message), DrawableUtil.getDrawable(context, R.drawable.common_error_24dp),
                ColorUtil.getColor(context, R.color.toast_info_color), ColorUtil.getColor(context, R.color.toast_default_text_color),
                duration, withIcon, true);
    }
    ...
    public static Toast success(@NonNull Context context, @StringRes int message, int duration, boolean withIcon) {
        return custom(context, context.getString(message), DrawableUtil.getDrawable(context, R.drawable.common_check_white),
                ColorUtil.getColor(context, R.color.toast_success_color), ColorUtil.getColor(context, R.color.toast_default_text_color),
                duration, withIcon, true);
    }

    @CheckResult
    public static Toast success(@NonNull Context context, @NonNull CharSequence message, int duration, boolean withIcon) {
        return custom(context, message, DrawableUtil.getDrawable(context, R.drawable.common_check_white),
                ColorUtil.getColor(context, R.color.toast_success_color), ColorUtil.getColor(context, R.color.toast_default_text_color),
                duration, withIcon, true);
    }
    ...
    public static Toast error(@NonNull Context context, @StringRes int message, int duration, boolean withIcon) {
        return custom(context, context.getString(message), DrawableUtil.getDrawable(context, R.drawable.common_cancel_24dp),
                ColorUtil.getColor(context, R.color.toast_error_color), ColorUtil.getColor(context, R.color.toast_default_text_color),
                duration, withIcon, true);
    }

    @CheckResult
    public static Toast error(@NonNull Context context, @NonNull CharSequence message, int duration, boolean withIcon) {
        return custom(context, message, DrawableUtil.getDrawable(context, R.drawable.common_cancel_24dp),
                ColorUtil.getColor(context, R.color.toast_error_color), ColorUtil.getColor(context, R.color.toast_default_text_color),
                duration, withIcon, true);
    }
    ...
    public static Toast custom(@NonNull Context context, @StringRes int message, Drawable icon,
        ...
        return custom(context, context.getString(message), icon, -1, ColorUtil.getColor(context, R.color.toast_default_text_color),
    ...
    public static Toast custom(@NonNull Context context, @NonNull CharSequence message, Drawable icon,
                               int duration, boolean withIcon) {
        return custom(context, message, icon, -1, ColorUtil.getColor(context, R.color.toast_default_text_color),
                duration, withIcon, false);
    }
    ...
    public static Toast custom(@NonNull Context context, @StringRes int message, @DrawableRes int iconRes,
        ...
        return custom(context, context.getString(message), DrawableUtil.getDrawable(context, iconRes),
                ColorUtil.getColor(context, tintColorRes), ColorUtil.getColor(context, R.color.toast_default_text_color),
    ...
    public static Toast custom(@NonNull Context context, @NonNull CharSequence message, @DrawableRes int iconRes,
                               @ColorRes int tintColorRes, int duration,
                               boolean withIcon, boolean shouldTint) {
        return custom(context, message, DrawableUtil.getDrawable(context, iconRes),
                ColorUtil.getColor(context, tintColorRes), ColorUtil.getColor(context, R.color.toast_default_text_color),
                duration, withIcon, shouldTint);
    }
    ...
    public static Toast custom(@NonNull Context context, @StringRes int message, Drawable icon,
                               @ColorRes int tintColorRes, int duration,
                               boolean withIcon, boolean shouldTint) {
        return custom(context, context.getString(message), icon, ColorUtil.getColor(context, tintColorRes),
                ColorUtil.getColor(context, R.color.toast_default_text_color), duration, withIcon, shouldTint);
    }
    ...
    public static Toast custom(@NonNull Context context, @StringRes int message, Drawable icon,
                               ...
                               boolean withIcon, boolean shouldTint) {
        return custom(context, context.getString(message), icon, ColorUtil.getColor(context, tintColorRes),
                ColorUtil.getColor(context, textColorRes), duration, withIcon, shouldTint);
    }
    ...
    public static Toast custom(@NonNull Context context, @NonNull CharSequence message, Drawable icon,
        ...
        if (shouldTint) {
            drawableFrame = DrawableUtil.tint9PatchDrawableFrame(context, tintColor);
        } else {
            drawableFrame = DrawableUtil.getDrawable(context, R.drawable.toast_frame);
        }
        BackgroundUtil.setBackground(toastLayout, drawableFrame);
        ...
        if (withIcon) {
            ...
            BackgroundUtil.setBackground(toastIcon, Config.get().tintIcon ? DrawableUtil.tintIcon(icon, textColor) : icon);
        } else {
