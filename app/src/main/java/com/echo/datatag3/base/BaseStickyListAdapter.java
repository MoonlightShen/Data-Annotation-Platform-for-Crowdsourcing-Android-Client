...
import com.echo.datatag3.widget.stickyhead.StickyJudge;

import java.util.ArrayList;
import java.util.List;

//TODO 具体实现
public class BaseStickyListAdapter<T extends StickyJudge, VH extends RecyclerView.ViewHolder> extends BaseItemListAdapter<T, VH> {
