...
import com.echo.datatag3.util.system.DimensionUtil;
...
public class TabControlView extends RadioGroup implements HasTypeface {
    ...
    private void initAttrs(Context context, AttributeSet attrs) throws Exception {
        TypedArray attributes = context.getTheme().obtainStyledAttributes(
                ...
                0, 0);
        try {
            mTextSize = attributes.getDimensionPixelSize(R.styleable.TabControlView_tcv_textSize, DimensionUtil.getDimensionPixelSize(context, R.dimen.default_tcv_text_size));
            mSelectedColor = attributes.getColor(R.styleable.TabControlView_tcv_selectedColor, ColorUtil.getColor(context, R.color.colorPrimary));
            ...
            mUnselectedTextColor = attributes.getColor(R.styleable.TabControlView_tcv_unselectedTextColor, ColorUtil.getColor(context, R.color.colorPrimary));
            mStrokeWidth = attributes.getDimensionPixelSize(R.styleable.TabControlView_tcv_strokeWidth, DimensionUtil.getDimensionPixelSize(context, R.dimen.default_tcv_stroke_width));
