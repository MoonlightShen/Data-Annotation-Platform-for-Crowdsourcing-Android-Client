package com.echo.datatag3.widget.badgeview;
...
import com.echo.datatag3.util.system.DensityUtil;
import com.echo.datatag3.util.system.MathUtil;
...
public class BadgeView extends View implements Badge {
    ...
    private void init() {
        ...
        mBadgeTextSize = DensityUtil.sp2px(getContext(), DEFAULT_TEXT_SIZE);
        mBadgePadding = DensityUtil.dp2px(getContext(), DEFAULT_BADGE_PADDING);
        mBadgeNumber = 0;
        mBadgeGravity = Gravity.END | Gravity.TOP;
        mGravityOffsetX = DensityUtil.dp2px(getContext(), DEFAULT_GRAVITY_OFFSET);
        mGravityOffsetY = DensityUtil.dp2px(getContext(), DEFAULT_GRAVITY_OFFSET);
        ...
        switch (event.getActionMasked()) {
            ...
            case MotionEvent.ACTION_POINTER_DOWN:
                ...
                if (mDraggable && event.getPointerId(event.getActionIndex()) == 0
                    ...
                    mDefaultRadius = DensityUtil.dp2px(getContext(), 7);
