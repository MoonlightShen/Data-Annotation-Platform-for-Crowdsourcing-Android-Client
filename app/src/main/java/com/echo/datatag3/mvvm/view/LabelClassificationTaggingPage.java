...
import com.echo.datatag3.base.BaseSelectableListAdapter;
...
import com.echo.datatag3.databinding.PageLabelClassificationTaggingBinding;
import com.echo.datatag3.mvvm.model.LabelClassificationTaggingModel;
import com.echo.datatag3.mvvm.view.task.TaskEditingInfoPage;
import com.echo.datatag3.mvvm.viewmodel.LabelClassificationTaggingViewModel;
...
public class LabelClassificationTaggingPage extends BaseCustomActivity<LabelClassificationTaggingViewModel, LabelClassificationTaggingModel, PageLabelClassificationTaggingBinding> {

    TopRightMenu topRightMenu;

    @Override
    protected int getContentViewId() {
        return R.layout.page_label_classification_tagging;
    }
                ...
                if (untaggingDataSet != null) {
                    ...
                    adapter.setSelectCallback(position -> {
                        if (adapter.isSelect(position)){
                            ToastUtil.toast("您选择了:"+adapter.getItem(position).content);
                        }else {
                            ToastUtil.toast("您取消了:"+adapter.getItem(position).content);
                        }
                    });
